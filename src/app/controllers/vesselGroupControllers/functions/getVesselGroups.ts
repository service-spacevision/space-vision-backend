...
export async function getVesselGroups_func({ reqObject, query, pagination }: GetVesselGroupsParams) {
  try {
    const whereCondition = query?.groupName ? eq(vesselGroups.groupName, query.groupName) : undefined
