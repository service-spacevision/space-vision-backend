...
const WINDOW_MS = parseNumberEnv(process.env.LOGIN_RATE_LIMIT_WINDOW_MS, 15 * 60 * 1000)
const MAX_ATTEMPTS = parseNumberEnv(process.env.LOGIN_RATE_LIMIT_MAX_ATTEMPTS, 5)
const BLOCK_MS = parseNumberEnv(process.env.LOGIN_RATE_LIMIT_BLOCK_MS, 15 * 60 * 1000)
