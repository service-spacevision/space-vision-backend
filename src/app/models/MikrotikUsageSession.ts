...
import { pgTable, text, integer, timestamp, serial, decimal } from "drizzle-orm/pg-core";
...
export type MikrotikUsageSession = InferSelectModel<typeof mikrotikUsageSession>;
export type NewMikrotikUsageSession = InferInsertModel<typeof mikrotikUsageSession>;
